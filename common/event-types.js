...
export const PLAYER_PASSWORD_RESET_REQUESTED = 'PLAYER_PASSWORD_RESET_REQUESTED'
export const PLAYER_PASSWORD_RESET_FORGOTTEN = 'PLAYER_PASSWORD_RESET_FORGOTTEN'
export const PLAYER_PASSWORD_RESET_RESPONDED = 'PLAYER_PASSWORD_RESET_RESPONDED'
export const PLAYER_PASSWORD_CHANGED = 'PLAYER_PASSWORD_CHANGED'
